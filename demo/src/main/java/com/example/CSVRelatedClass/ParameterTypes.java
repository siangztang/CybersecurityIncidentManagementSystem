...
public class ParameterTypes {
    public final static Class<?>[] RESPONSE_TEAM_PARAMETER_TYPES = {String.class, String.class};
    public final static Class<?>[] RESPONSE_TEAM_USER_PARAMETER_TYPES = {String.class, String.class, String.class, String.class, String.class, String.class};
